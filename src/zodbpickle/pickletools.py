...
>>> dis(pickle.dumps(pickletools.dis, 0))
    0: c    GLOBAL     'zodbpickle.pickletools dis'
   28: p    PUT        0
   31: .    STOP
highest protocol among opcodes = 0

>>> from zodbpickle.pickletools import _Example
>>> x = [_Example(42)] * 2
>>> dis(pickle.dumps(x, 0))
    ...
    2: p    PUT        0
    5: (    MARK
    6: i        INST       'zodbpickle.pickletools _Example' (MARK at 5)
   39: p    PUT        1
   42: (    MARK
...
>>> dis(pickle.dumps(x, 1))
    ...
    3: (    MARK
    4: (        MARK
    5: c            GLOBAL     'zodbpickle.pickletools _Example'
   28: q            BINPUT     1
   40: o            OBJ        (MARK at 4)
   41: q        BINPUT     2
   43: }        EMPTY_DICT
